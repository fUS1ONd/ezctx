...
void main() {
  group('Integration: ChunkedTranscriptionController — полный пайплайн', () {
    ...
    test('сценарий 1 — happy path 2 чанка: ChunkedSuccess, текст с таймкодами', () async {
      ...
      // Сегмент в чанке 1 (offset=1200s): [00:20:00] Как дела
      ...
      // Чанк 1: offset=1200s (20 мин), seg.start=0 → абсолютное время 1200s → [00:20:00]
      expect(result.text, contains('[00:20:00] Как дела'),
          reason: 'Второй чанк с offset 1200s должен иметь таймкод [00:20:00]');
    });
