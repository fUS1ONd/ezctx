...
- Usage: Reference from command with `@/home/krivonosov/projects/ezctx/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/krivonosov/projects/ezctx/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/krivonosov/projects/ezctx/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
