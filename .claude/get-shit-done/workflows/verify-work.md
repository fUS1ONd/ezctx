...
<template>
@/home/krivonosov/projects/ezctx/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@/home/krivonosov/projects/ezctx/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `/home/krivonosov/projects/ezctx/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @/home/krivonosov/projects/ezctx/.claude/get-shit-done/workflows/diagnose-issues.md
