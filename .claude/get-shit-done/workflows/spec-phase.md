...
```bash
INIT=$(node "/home/krivonosov/projects/ezctx/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/krivonosov/projects/ezctx/.claude/get-shit-done/templates/spec.md.
