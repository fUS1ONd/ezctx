...
- **Global scope**: `/home/krivonosov/projects/ezctx/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/krivonosov/projects/ezctx/.claude/notes/`)
...
2. Glob `/home/krivonosov/projects/ezctx/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/krivonosov/projects/ezctx/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/krivonosov/projects/ezctx/.claude/notes/` — works in any directory
