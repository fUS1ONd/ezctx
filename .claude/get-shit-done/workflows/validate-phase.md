...
```
Agent(
  prompt="Read /home/krivonosov/projects/ezctx/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/krivonosov/projects/ezctx/.claude/get-shit-done/templates/VALIDATION.md`
