...
```bash
INIT=$(node "/home/krivonosov/projects/ezctx/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/krivonosov/projects/ezctx/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
