...
INSTALL_JS_GLOBAL="/home/krivonosov/projects/ezctx/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/krivonosov/projects/ezctx/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
